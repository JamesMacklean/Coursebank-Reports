...
urlpatterns = [
    ...
    url(r'^reports/course/{}/enrollments/exportCSV/$'.format(settings.COURSE_ID_PATTERN), views.enrollment_list_view, {'export_csv': True}, name='export-enrollments-reports'),
]
